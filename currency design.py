...
#main frame
result = Label(main, text = " ",width=2, height=5, pady=7, relief="solid", anchor=CENTER, font=('Ivy 15 bold'), bg=cor0, fg=cor1)
result.placee(x=50, y=10)

currency = ['BRL', 'CAD', 'EUR', 'GPB', 'INR', 'USD']
...
combo1 = ttk.Combobox(main, width=8, justify=CENTER, front=("Ivy 12 bold"))
...
combo2 = ttk.Combobox(main, width=8, justify=CENTER, front=("Ivy 12 bold"), reliefy=SOLID)
